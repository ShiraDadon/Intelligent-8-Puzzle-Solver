...
The board contains 8 numbered tiles and one blank space, represented by `0`.
...
The heuristic combines **Manhattan distance** and **linear conflict**.
...
**Linear conflict** occurs when two tiles are already in their correct goal row or column, but appear in the wrong relative order.  
Each conflict adds two extra moves to the heuristic estimate.
